...
@Suite
struct `InputStream Extension Tests` {
  @Test
  func `InputStream compression stream produces valid output`() async throws {
  ...
  @Test
  func `InputStream decompression stream produces valid output`() async throws {
  ...
  @Test
  func `InputStream with larger data`() async throws {
  ...
  @Test
  func `InputStream round-trip through streams`() async throws {
  ...
  @Test
  func `InputStream with custom configuration`() async throws {
